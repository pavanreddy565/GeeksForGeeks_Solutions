<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-series2811/1?page=1&status=unsolved&sortBy=submissions">Sum of Series</a></h2><h3>Difficulty Level : Difficulty: School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Write a program to find the sum of the given series 1+2+3+ . . . . . . (n terms)&nbsp;</span></p>
